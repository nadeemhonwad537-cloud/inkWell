    ...
    <div style={{ maxWidth: 700, margin: '0 auto', padding: '3rem 2rem 5rem' }}>
      ...
      <div style={{ marginBottom: '2rem' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '.75rem', marginBottom: '1rem', fontSize: '.7rem', color: 'var(--muted)', fontWeight: 500 }}>
          ...
          <span>{new Date(post.created_at + 'Z').toLocaleDateString('en-IN', { day: 'numeric', month: 'short', year: 'numeric', timeZone: 'Asia/Kolkata' })} · {new Date(post.created_at + 'Z').toLocaleTimeString('en-IN', { hour: '2-digit', minute: '2-digit', timeZone: 'Asia/Kolkata', hour12: true })}</span>
